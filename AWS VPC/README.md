...
Part 1.
Navigate to the search bar
- Enter "VPC." Upon locating the relevant result, proceed to click on it, directing you to the Virtual Private Cloud (VPC) page and click Please navigate to the "Create VPC" option and click on it
![landing page](./IMG/VPC%20landing%20page.png)

- Please select the "VPC only" option, specify the IPv4 CIDR block, and proceed by clicking on the "Create VPC" button.
![1st setting ](./img/second%20selection.png) and 
![2nd setting ](./img/third%20selection.png)
From the settings, select VPC only instead of VPC and more.
...
![creat subnet](./img/subnet.png)

Please select the ID of the VPC that you created in the previous step (Part 1)
![vpc id](./img/creating%20subnets%201.png)
![vpc id](./img/1st%20subnet.png)
![vpc id](./img/2nd%20subnet.png)
![vpc id](./img/hit%20create%20subnet.png)

Here you’ll see your subnets is being c

Part-3
Navigate to the "Internet Gateway" option on the left sidebar.
- Upon clicking, you will be directed to the Internet Gateway page.
![gateway](./img/internet%20gateway%20page.png)

- From there, proceed to click on the "Create Internet Gateway" button
![gateway](./img/create%20internet%20gateway.png)

Specify the name of the Internet Gateway
- proceed by clicking on the "Create Internet Gateway" button.
![create gateway](./img/create%20gateway.png)

Now your Internet gateway is being successfully created,Now, you will notice that it is currently detached, indicating that it is not associated with any VPC. To enable internet connectivity, you must attach the Internet Gateway to the VPC you have previously created. hit the action tab and select attach to VPC.
![Action](./img/Action%20and%20Vpc.png)

Attached VPC and gateway
![vpc](./img/attached.png)
...
![created route](./img/created%20route.png)

- Next, click on "Subnet associations," followed by "Edit subnet associations" to associate the subnet with this route table, 

![subnet](./img/subnet%20association.png)

We’ll associate the public subnet with this route table.
![subnet association](./img/associate%20subnet.png)

Navigate to "Routes" and then click on "Edit routes."
![edit route](./img/edit%20route.png)

Click and add destination 0.0.0.0/0 and the internet gateway which is connected to the public ip.
![adding route](./img/adding%20route.png)

The added route will look like this

![added route](./img/added%20route.png)
...
Then mention the name of the NAT Gateway.
![NAT gateway](./img/NAT%20gatwa%20created.png)
...
- From there, locate the subnet ID and click on it.
![Landing NAT page](./img/nat%20landing%20page.png)

This take you to the screen below,

![routing table](./img/routing%20table.png)

 On this screen, select your private network, this enables you to see and select the routing table. click on the routing table ID
 Proceed to the "Routes" section, then click on "Edit routes."
![edit route](./img/edit%20routes.png)

Then click on “Add routes. 

![route screen](./img/edit%20route%20screen.png)
...
![route](./IMG/adding%20route%20NAT.png)

Nex, click on the subnet association section, click on edit subnet association.

![route](./img/24.png)

Choose the private subnet and click on “Save associations”
![choose route](./img/choose.png)

Now, the subnet has been successfully attached with the route table.

![attached route](./img/attached%20it.png)
...
Part -6
Let's begin by creating two VPCs in the same region. Alternatively, you may choose a different region if needed.
create VPC named requester VPC
![requester](./IMG/Requester%20VPC.png)

and an accpetor VPC

![acceptor](./IMG/accepter%20VPC.png)
...
![peering](./img/peering%20land%20page.png)
Now, provide a name for the VPC peering connection.
...
![peering done](./img/peering%20connection.png)

peering confirmed belo

![peering confirmed](./img/peering%20confirmed.png)

In the Peering Connection page, locate the "Actions" option on the right side.
- Click on it, then select "Accept Request."

![acceptor request](./img/accept%20request.png)

then click confirm request

![confirmed](./img/confirm%20acception.png)

Now, click on Main route table ID of the accepter VPC.
![route table](./img/1st.png/)
...
![peering receiver](./img/peering%20receiver%20to%20acceptor.png)
...
![peered](./img/peering%20acceptor%20to%20receiver.png)
